...
# Preview:
X86_NV_PACKAGE="devdriver_5.0_linux_32_${PV}"
AMD64_NV_PACKAGE="devdriver_5.0_linux_64_${PV}"
# Stable:
...
pkg_nofetch() {
	use amd64 && elog "Please download ${AMD64_NV_PACKAGE}.run from:"
	use x86   && elog "Please download ${X86_NV_PACKAGE}.run from:"
