...
src_install() {
    ...
    mkdir -p ${D}/usr/lib
    ln -s ${_installdir}/lib/${_arch}/libOpenCL.so ${D}/usr/lib/libOpenCL.so
    ln -s libOpenCL.so ${D}/usr/lib/libOpenCL.so.$_OpenCL_ver_major.$_OpenCL_ver_minor
    ln -s libOpenCL.so ${D}/usr/lib/libOpenCL.so.$_OpenCL_ver_major
    ...
    ln -s ${_installdir}/lib/${_arch}/libamdocl64.so ${D}/usr/lib/libamdocl64.so
