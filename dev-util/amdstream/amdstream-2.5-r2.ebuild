...
SRC_URI="http://developer.amd.com/Downloads/AMD-APP-SDK-v${PV}-lnx${_bits}.tgz"
LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~amd64"
...
S="${WORKDIR}/AMD-APP-SDK-v${PV}-RC2-lnx${_bits}"

src_unpack() {
	default_src_unpack
	cd ${WORKDIR}
	tar xf AMD-APP-SDK-v${PV}-RC2-lnx${_bits}.tgz
}
