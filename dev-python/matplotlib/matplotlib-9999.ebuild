...
src_prepare() {
    ...
    cp lib/matplotlib/mpl-data/matplotlib.conf.template lib/matplotlib/mpl-data/matplotlib.conf || die "Can't find 'matplotlib.conf.template'"
    ...
    cd examples
    git clone ${EGIT_STORE_DIR}/sample_data.git
    cd ..
