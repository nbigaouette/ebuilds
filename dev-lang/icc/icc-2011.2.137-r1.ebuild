...
RESTRICT="mirror strip bindist binchecks"
...
DESTINATION="opt/intel/composerxe-${RELEASE}.${BUILD}"
...
# 	fi
    ...
    grep -rl "SUBSTITUTE_INTEL64_ARCH_HERE" ${ED}${DESTINATION}/* | xargs sed -i "s|SUBSTITUTE_INTEL64_ARCH_HERE|/${IARCH}|g"       || die "Can't sed for SUBSTITUTE_INTEL64_ARCH_HERE!!!"
    grep -rl "SUBSTITUTE_INSTALL_DIR_HERE"  ${ED}${DESTINATION}/* | xargs sed -i "s|SUBSTITUTE_INSTALL_DIR_HERE|/${DESTINATION}|g"  || die "Can't sed for SUBSTITUTE_INTEL64_ARCH_HERE!!!"
